        ...
        for (var k = 0; k < ListaProyectos.length; k++) {
            for (index = 0; index < arregloCaptura.length; index++) {
                ...
                if (arregloCaptura[index].Agregar) {
                    ListaDetalles[i] = { Accion: "", ProcesoPinturaID: "", MetrosLote: "", NumeroPruebas: "", ProyectoID: "", ListadoPruebas: [], Estatus: 1, NumeroComponentes: "", ReductorID: "", ListaDetalleComponentesAgregados: [], potlife: "", curadoTemp: "", retoquetemp: "",ConfiguracionLote:"" };
                    ...
                    ListaDetalles[i].curadoTemp = arregloCaptura[index].curado;
                    ListaDetalles[i].potlife = arregloCaptura[index].potlife;
                    ListaDetalles[i].retoquetemp = arregloCaptura[index].retoque;
                    ListaDetalles[i].ConfiguracionLote = arregloCaptura[index].ConfiguracionLote;
                    ...
                    if (arregloCaptura[index].Agregar && (arregloCaptura[index].ConfiguracionLote==null||arregloCaptura[index].ConfiguracionLote==undefined ||   arregloCaptura[index].MetrosLote == null || arregloCaptura[index].MetrosLote == 0 || arregloCaptura[index].NumeroPruebas == 0 || arregloCaptura[index].NumeroPruebas == null || arregloCaptura[index].listadoPruebasDetalle.length == 0 || arregloCaptura[index].NumeroComponentes == 0 || tieneComponentesSinCaptura(arregloCaptura[index].ListaDetalleComponentesAgregados))) {
                        ListaDetalles[i].Estatus = 0;
                        arregloCaptura[index].RowOk = false;
                    }
                    i++;
