...
function CargarGrid() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            { field: "PorPagar", title: _dictionary.columnPorPagar[$("#language").data("kendoDropDownList").value()], filterable: getGridFilterableCellNumberMaftec(), width: "73px", editor: RenderPorCobrar, attributes: { style: "text-align:right;" } },
