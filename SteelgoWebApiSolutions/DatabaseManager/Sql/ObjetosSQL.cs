...
namespace DatabaseManager.Sam3
{
    public class ObjetosSQL
    {
        ...
        protected SqlConnection Conexion()
        {
            ...
            //server=DESKTOP-ERP53TE\PRODUCCION;initial catalog=steelgo-sam3;User=sa;Password=maftec09;MultipleActiveResultSets=True;Connect Timeout=2000"
            //return new SqlConnection(@"server=DESKTOP-ERP53TE\PRODUCCION;initial catalog=steelgo-sam3;User=sa;Password=maftec09;MultipleActiveResultSets=True;Connect Timeout=2000");
